...
const DashBoard = () => {
    return (
        <div>
            <div className="h-screen w-full bg-white relative flex overflow-hidden">
                ...
                {/* <!-- Sidebar --> */}
                <aside className="h-full w-16 flex flex-col space-y-10 items-center justify-center relative bg-gray-900 text-white">
                    {/* <!-- Profile --> */}
  ...
  <!-- Configuration --> */}
                ...
                <div className="w-full h-full flex flex-col justify-between">
                    {/* <!-- Header --> */}
                    <header className="h-16 w-full flex items-center relative justify-end px-5 space-x-10 bg-gray-900">
                        {/* <!-- Informação --> */}
                        <h1 className="text-white text-xl sm:text-2xl md:text-4xl mr-auto">
                            DASHBOARD
                        </h1>
                    ...
                    <main className="max-w-full h-full flex relative overflow-y-hidden">
                        {/* <!-- Container --> */}
                        <div className="h-full w-full m-4 flex flex-wrap items-start justify-start rounded-tl grid-flow-cols auto-cols-max gap-4 overflow-y-scroll">
                            {/* <!-- Container --> */}
